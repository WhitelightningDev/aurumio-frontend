...
export default function BuyNew() {
  ...
  const netPerUnit = useMemo(() => calcNetPerUnit('buyer', productId, grossNum), [productId, grossNum]);
  ...
  return (
    <section className="space-y-4">
      <h1 className="text-2xl font-semibold">Create Buy Offer</h1>
      <div className="card border border-neutral-200 p-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          ...
          <div>
            <label className="typo-label text-neutral-700" htmlFor="price">Offer price (ZAR per unit)</label>
        ...
        <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-3">
          <div className="rounded-md border border-neutral-200 p-3 bg-neutral-050">
            <div className="text-sm text-neutral-600">Fee (buyer side) per unit</div>
            <div className="mt-1 text-lg font-semibold tnum">R{feePerUnit.toFixed(0)}</div>
          </div>
          <div className="rounded-md border border-neutral-200 p-3 bg-neutral-050">
            <div className="text-sm text-neutral-600">Your net per unit</div>
        ...
        <div className="mt-4">
          <button className="btn-base btn-primary focus-ring" onClick={async()=>{
            try {
              ...
              // Only show one toast
              toast.show('Buy offer posted. Matching in progress.', { type: 'success' });
